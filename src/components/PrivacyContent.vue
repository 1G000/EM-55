  ...
  <ol>
    <li class="first__level">
      ...
      <p>
        ...
        безопасности персональных данных, предпринимаемые ООО "Электромонтаж 55"
        (далее — Оператор).
      </p>
      <ol class="second__level">
        <li>
        ...
        <li>
          ...
          Оператор может получить о посетителях веб-сайта https://em-55.com.
        </li>
      </ol>
    </li>
    ...
    <li class="first__level">
      ...
      <ol class="second__level">
        ...
        <li>
          ...
          сети интернет по сетевому адресу https://em-55.com.
        </li>
        <li>
        ...
        <li>
          2.10. Пользователь — любой посетитель веб-сайта https://em-55.com.
        </li>
        <li>
    ...
    <li class="first__level">
      ...
      <ol class="second__level">
        <li>
          ...
          информацию и/или документы, содержащие персональные данные; <br />— в
        ...
        <li>
          ...
          действующим законодательством РФ; <br />— отвечать на обращения и
          ...
          дней с даты получения такого запроса; <br />— публиковать или иным
          образом обеспечивать неограниченный доступ к настоящей Политике в
    ...
    <li class="first__level">
      ...
      <p>
        ...
        и/или по месту пребывания;<br />
        — сведения об образовании, профессии, специальности и квалификации,
        реквизиты документов об образовании;<br />
        — сведения о занимаемых ранее должностях и стаже работы, воинской
        обязанности, воинском учете;<br />
        — иные данные,указанные в резюме.<br />
      </p>
    </li>
    <li class="first__level">
    ...
    <li class="first__level">
      ...
      <ol class="second__level">
        ...
        <li>
          ...
          referent@em-55.com с пометкой «Актуализация персональных данных».
        </li>
        <li>
          ...
          referent@em-55.com с пометкой «Отзыв согласия на обработку
          персональных данных».
        </li>
        <li>
    ...
    <li class="first__level">
      ...
      <ol class="second__level">
        <li>
          ...
          Оператору с помощью электронной почты referent@em-55.com.
        </li>
        <li>
        ...
        <li>
          ...
          сети Интернет по адресу https://em-55.com/privacy.
        </li>
      </ol>
    </li>
  </ol>
